 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Natalie Castro");
		  toPrint += p1.toString("ncastro8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Kui Sit");
		  toPrint += p2.toString("ksit3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Connor Wyckoff");
		  toPrint += p3.toString("cwyckoff3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Nic Alton");
                  toPrint += p4.toString("aalton3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5(" Alex Labanowski ");
                  toPrint += p5.toString("alabanowski3");
